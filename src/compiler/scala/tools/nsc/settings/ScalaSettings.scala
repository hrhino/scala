...
trait ScalaSettings extends AbsScalaSettings
  ...
  val Yvalidatepos    = BooleanSetting    ("-Yvalidate-pos", "Validate range positions.")
  val Ymemberpos      = StringSetting     ("-Yshow-member-pos", "output style", "Show start and end positions of members", "")
